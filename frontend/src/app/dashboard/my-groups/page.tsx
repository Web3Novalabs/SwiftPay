...
const page = () => {
  return (
    <div className="bg-sky-500">
      ...
      fuga sit nesciunt soluta quisquam pariatur quaerat eaque incidunt
      recusandae, error exercitationem alias quae officiis magni corrupti
      cupiditate, neque totam eius dolorum quas dolore iste. Mollitia, dolor
