...
pub mod AutoShareParent {
    ...
    use crate::interfaces::iautoshare_parent::IAutoShareParent;
    ...
    pub struct Storage {
        ...
        group_addresses: Map<u256, ContractAddress>,
    ...
    pub fn constructor(
        ...
        self.emergency_withdraw_address.write('0x0123'.try_into().unwrap());
    ...
    #[abi(embed_v0)]
    impl AutoShareParentImpl of IAutoShareParent<ContractState> {
        fn create_group(
            ref self: ContractState,
            name: ByteArray,
            amount: u256,
            ...
            let (counter_address_for_group, _) = deploy_syscall(
                self.child_contract_class_hash.read(), 0, constructor_calldata.span(), false,
            )
                .unwrap();
            self.group_addresses.write(id, counter_address_for_group);
